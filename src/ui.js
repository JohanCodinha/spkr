...
export function cacheElements() {
    getState().setElements({
        ...
        revealConfirmMessage: document.getElementById('reveal-confirm-message'),
        revealConfirmYes: document.getElementById('reveal-confirm-yes'),
        revealConfirmNo: document.getElementById('reveal-confirm-no'),
